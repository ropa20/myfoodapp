...
const RecipeList = (props) => {
    ...
    const isWished = (item) =>
        (wish.length > 0)?((wish.some(e => e.label === item.recipe.label)) ? "fa-solid fa-heart fa-2xl wished-item" : "fa-solid fa-heart fa-2xl not-wished-item"):"fa-solid fa-heart fa-2xl not-wished-item"
        ...
        // {test(elem.recipe)}
            ...
            <div className='big-card1'>                
                <div class="a-box">
                    ...
                    <i className={isWished(elem)} onClick={()=> handleWishlist(elem)}></i>
                    ...
                    <div class="text-container">
                        ...
                        <Modal
                            ...
                            footer={[
                                ...
                                <button className='recipe' key="submit" type="primary" onClick={()=>window.open(elem.recipe.url)}>
                                    Full Recipe
                                </button>,
                        ...
                        <button className='recipe' type="button" onClick={()=>window.open(elem.recipe.url)}>Full Recipe</button>
                        </p>
                    </div>
                </div>
            </div>
